...
class AdminApiControllerTest {
    ...
    public void getUserDetails() throws Exception {
        UserDetailResponse userDetailsResponse = UserDetailResponse.builder()
                .id(1L)
                .email("jungkh405@naver.com")
                .nickname("17171771")
                .modifiedDate(LocalDateTime.now())
                .createdDate( LocalDateTime.of(2022, 1, 25, 12, 30, 0))
        ...
        mockMvc.perform(get("/admin/users/{id}", 1)
                ...
                .andDo(document("admin/get/details", pathParameters(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("createdDate").type(JsonFieldType.VARIES).description("회원 가입 일시"),
